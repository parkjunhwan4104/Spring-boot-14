...
public class DogController {
    ...
    public Dog getDogsByOwnerName(@PathVariable String ownerName){return dogManagementService.getDogByOwnerName(ownerName);}

    @GetMapping("/dogs/,,{ownerPhoneNumber}")
    public Dog getDogsByOwnerPhoneNumber(@PathVariable String ownerPhoneNumber){
        return dogManagementService.getDogByOwnerPhoneNumber(ownerPhoneNumber);
    }

    @GetMapping("/dogs/{name}/{ownerName}/{ownerPhoneNumber")
    public Dog getDogsExact(@PathVariable String name, String ownerName, String ownerPhoneNumber){
        return dogManagementService.getDogExact(name, ownerName, ownerPhoneNumber);
    }
}
